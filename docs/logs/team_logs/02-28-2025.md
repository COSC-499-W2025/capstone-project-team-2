...
---
## Overview:
This log represents the last 3 weeks of work. Last week we had our peer testing session. A few bugs were found, and we worked on those that week, however, most of the feedback was front end stuff, which we will address once the GUI system is up and running.
