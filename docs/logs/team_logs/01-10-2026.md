...
![alt text](https://github.com/COSC-499-W2025/capstone-project-team-2/blob/team_logs/docs/logs/team_logs/screenshots/kanban_board/KanBan%202026-01-10%20163543.png)

---

## Burn-up Chart (Velocity):
![alt text](https://github.com/COSC-499-W2025/capstone-project-team-2/blob/team_logs/docs/logs/team_logs/screenshots/Burn_up_charts/Burnup_Chart-2026-01-10%20163354.png)
...
| Puneet Maan      | Full Stack Developer | [@Puneet-Maan](https://github.com/Puneet-Maan)           |N/A|
...
| [#263] (https://github.com/COSC-499-W2025/capstone-project-team-2/pull/263)|Adds a Comprehensive RenderCV Generator Module(Generate_RenderCV_Resume.py)
which is responsible for creating and managing CV/Resume YAML files, being stored in the system:| Immanuel Wiessler     |
